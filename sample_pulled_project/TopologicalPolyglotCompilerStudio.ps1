...
# Verified .NET Type References: [System.Drawing.FontStyle]::Bold
# ============================================================================
...
$form.Text = "ACT-Ω Dedicated Polyglot Compiler Studio [PowerShell Self-Deploying Copy/Paste Ready]"
...
$lblSub.Text = "Pre-Loaded Prompts -> Semantic Lexicon -> E8 Vector Pinning -> BraidIR -> PowerShell Self-Deploying Code Export"
...
$grpLeft.Location = New-Object System.Drawing.Point(20, 75); $grpLeft.Size = New-Object System.Drawing.Size(390, 760); $grpLeft.BackColor = [System.Drawing.Color]::FromArgb(16, 20, 31)
...
$txtLexiconOut.Multiline = $true; $txtLexiconOut.ScrollBars = "Both"; $txtLexiconOut.Size = New-Object System.Drawing.Size(365, 530); $txtLexiconOut.Location = New-Object System.Drawing.Point(12, 215)
...
$grpMiddle.Location = New-Object System.Drawing.Point(420, 75); $grpMiddle.Size = New-Object System.Drawing.Size(390, 760); $grpMiddle.BackColor = [System.Drawing.Color]::FromArgb(16, 20, 31)
...
$txtBraidOut.Multiline = $true; $txtBraidOut.ScrollBars = "Both"; $txtBraidOut.Size = New-Object System.Drawing.Size(365, 675); $txtBraidOut.Location = New-Object System.Drawing.Point(12, 68)
...
# PANEL 3: RIGHT PANEL - CODE DOMAIN SYNTHESIS & POWERSHELL COPY/PASTE EXPORT
$grpRight = New-Object System.Windows.Forms.GroupBox
$grpRight.Text = "Panel 3: Code Domain & PowerShell Copy/Paste Export"; $grpRight.Font = New-Object System.Drawing.Font("Segoe UI", 9.5, [System.Drawing.FontStyle]::Bold); $grpRight.ForeColor = [System.Drawing.Color]::FromArgb(255, 215, 0)
$grpRight.Location = New-Object System.Drawing.Point(820, 75); $grpRight.Size = New-Object System.Drawing.Size(430, 760); $grpRight.BackColor = [System.Drawing.Color]::FromArgb(16, 20, 31)

$lblLang = New-Object System.Windows.Forms.Label
$lblLang.Text = "Domain Language:"; $lblLang.Font = New-Object System.Drawing.Font("Segoe UI", 9, [System.Drawing.FontStyle]::Bold); $lblLang.ForeColor = [System.Drawing.Color]::White; $lblLang.Location = New-Object System.Drawing.Point(12, 22); $lblLang.Size = New-Object System.Drawing.Size(120, 22)
$grpRight.Controls.Add($lblLang)

$cmbDomainLang = New-Object System.Windows.Forms.ComboBox
$cmbDomainLang.Location = New-Object System.Drawing.Point(135, 19); $cmbDomainLang.Size = New-Object System.Drawing.Size(130, 28); $cmbDomainLang.DropDownStyle = [System.Windows.Forms.ComboBoxStyle]::DropDownList
$cmbDomainLang.Items.Add("Python") | Out-Null; $cmbDomainLang.Items.Add("Rust") | Out-Null; $cmbDomainLang.Items.Add("C/C++") | Out-Null; $cmbDomainLang.Items.Add("TypeScript") | Out-Null; $cmbDomainLang.SelectedIndex = 0
$grpRight.Controls.Add($cmbDomainLang)

$lblFormat = New-Object System.Windows.Forms.Label
$lblFormat.Text = "Format:"; $lblFormat.Font = New-Object System.Drawing.Font("Segoe UI", 9, [System.Drawing.FontStyle]::Bold); $lblFormat.ForeColor = [System.Drawing.Color]::White; $lblFormat.Location = New-Object System.Drawing.Point(275, 22); $lblFormat.Size = New-Object System.Drawing.Size(55, 22)
$grpRight.Controls.Add($lblFormat)

$cmbOutputMode = New-Object System.Windows.Forms.ComboBox
$cmbOutputMode.Location = New-Object System.Drawing.Point(330, 19); $cmbOutputMode.Size = New-Object System.Drawing.Size(85, 28); $cmbOutputMode.DropDownStyle = [System.Windows.Forms.ComboBoxStyle]::DropDownList
$cmbOutputMode.Items.Add("PS Script") | Out-Null; $cmbOutputMode.Items.Add("Pure Code") | Out-Null; $cmbOutputMode.SelectedIndex = 0
$grpRight.Controls.Add($cmbOutputMode)

$btnCompileDomain = New-Object System.Windows.Forms.Button
$btnCompileDomain.Text = "Synthesize Domain Code"; $btnCompileDomain.Font = New-Object System.Drawing.Font("Segoe UI", 9.5, [System.Drawing.FontStyle]::Bold); $btnCompileDomain.BackColor = [System.Drawing.Color]::FromArgb(0, 122, 204); $btnCompileDomain.ForeColor = [System.Drawing.Color]::White; $btnCompileDomain.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat; $btnCompileDomain.Size = New-Object System.Drawing.Size(405, 32); $btnCompileDomain.Location = New-Object System.Drawing.Point(12, 54)
$grpRight.Controls.Add($btnCompileDomain)

$btnCopyCode = New-Object System.Windows.Forms.Button
$btnCopyCode.Text = "COPY POWERSHELL SCRIPT TO CLIPBOARD"; $btnCopyCode.Font = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold); $btnCopyCode.BackColor = [System.Drawing.Color]::FromArgb(0, 255, 102); $btnCopyCode.ForeColor = [System.Drawing.Color]::Black; $btnCopyCode.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat; $btnCopyCode.Size = New-Object System.Drawing.Size(405, 36); $btnCopyCode.Location = New-Object System.Drawing.Point(12, 92)
$grpRight.Controls.Add($btnCopyCode)

$btnSaveFile = New-Object System.Windows.Forms.Button
$btnSaveFile.Text = "SAVE CODE DIRECTLY TO FILE"; $btnSaveFile.Font = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold); $btnSaveFile.BackColor = [System.Drawing.Color]::FromArgb(255, 215, 0); $btnSaveFile.ForeColor = [System.Drawing.Color]::Black; $btnSaveFile.FlatStyle = [System.Windows.Forms.FlatStyle]::Flat; $btnSaveFile.Size = New-Object System.Drawing.Size(405, 36); $btnSaveFile.Location = New-Object System.Drawing.Point(12, 134)
$grpRight.Controls.Add($btnSaveFile)

$txtCodeOut = New-Object System.Windows.Forms.TextBox
$txtCodeOut.Multiline = $true; $txtCodeOut.ScrollBars = "Both"; $txtCodeOut.Size = New-Object System.Drawing.Size(405, 565); $txtCodeOut.Location = New-Object System.Drawing.Point(12, 178)
...
function Execute-DomainSynthesis {
    ...
    $outputMode = $cmbOutputMode.SelectedItem.ToString()

    if (Test-Path ".\topological_semantic_compiler.exe") {
        $promptClean = $promptText -replace "`r`n", " " -replace "`n", " "
        $rawCode = & ".\topological_semantic_compiler.exe" $promptClean $selectedLang *>&1 | Out-String
        
        $cleanSource = $rawCode -replace "^```[a-zA-Z]*`r?`n", "" -replace "`r?`n```$", ""

        if ($outputMode -eq "PS Script") {
            $selectedLower = $selectedLang.ToLower()
            $ext = ".py"
            $execCmd = "python3 .\topological_generated_code.py"

            if ($selectedLower -eq "rust") {
                $ext = ".rs"
                $execCmd = "rustc -O topological_generated_code.rs -o topological_generated_code.exe`r`n.\topological_generated_code.exe"
            } elseif ($selectedLower -eq "c/c++") {
                $ext = ".cpp"
                $execCmd = "g++ -O3 topological_generated_code.cpp -o topological_generated_code.exe`r`n.\topological_generated_code.exe"
            } elseif ($selectedLower -eq "typescript") {
                $ext = ".ts"
                $execCmd = "deno run topological_generated_code.ts"
            }

            $psBlock = "Set-Location `"C:\sovereign_manifold\santos-sync\topological_system_optimizer`"`r`n`r`n@'`r`n" + $cleanSource + "`r`n'@ | Out-File -FilePath `".\topological_generated_code" + $ext + "`" -Encoding utf8`r`n`r`n" + $execCmd
            $txtCodeOut.Text = $psBlock
            $btnCopyCode.Text = "COPY POWERSHELL SCRIPT TO CLIPBOARD"
        } else {
            $txtCodeOut.Text = $cleanSource
            $btnCopyCode.Text = "COPY PURE CODE TO CLIPBOARD"
        }
    }
}
...
$cmbOutputMode.add_SelectedIndexChanged({ Execute-DomainSynthesis })

$btnCopyCode.add_Click({
    if ($txtCodeOut.Text) {
        [System.Windows.Forms.Clipboard]::SetText($txtCodeOut.Text)
        [System.Windows.Forms.MessageBox]::Show("PowerShell Script Block Copied Directly to Clipboard!", "ACT-Ω Compiler Studio", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
    }
})
...
$btnSaveFile.add_Click({
    if ($txtCodeOut.Text) {
        ...
        $ext = ".ps1"
        if ($cmbOutputMode.SelectedItem.ToString() -eq "Pure Code") {
            $ext = ".py"
            if ($selectedLang -eq "rust") { $ext = ".rs" }
            elseif ($selectedLang -eq "c/c++") { $ext = ".cpp" }
            elseif ($selectedLang -eq "typescript") { $ext = ".ts" }
        }

        $saveDialog = New-Object System.Windows.Forms.SaveFileDialog
        $saveDialog.Filter = "Source Code File (*$ext)|*$ext|All Files (*.*)|*.*"
        $saveDialog.FileName = "topological_deploy_script$ext"
        
        if ($saveDialog.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) {
            [System.IO.File]::WriteAllText($saveDialog.FileName, $txtCodeOut.Text)
